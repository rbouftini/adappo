...
def create_agent(envs, epochs, cg_iters, cg_damping, max_kl, backtrack_coeff, backtrack_iters, max_lr):
    ...
    class TRPOAgent(Agent):
        def __init__(self, envs, policy, value, epochs, cg_iters, cg_damping, max_kl, backtrack_coeff, backtrack_iters, max_lr):
    ...
    return TRPOAgent(envs, policy, value, epochs, cg_iters, cg_damping, max_kl, backtrack_coeff, backtrack_iters, max_lr), policy, value